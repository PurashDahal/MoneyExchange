        ...
        SizedBox(height: 5,),
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text("Forget password ?",style: TextStyle(color: Colors.cyanAccent),),
                ],
              ),
            ),
            SizedBox(height: 5,),
            Visibility(
              visible:isVisible,
              child: Text(cred,style: TextStyle(color: Color.fromARGB(255, 238, 140, 133)),)),
            SizedBox(height: 15,),
            ClipRRect(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                 ...
                 var val2= sp2.getString(MySignUpState.KEY3);
                  ...
                  print('${val1}');
                    if(email.text=="${Cred.userName}"&& password.text=="${Cred.password}"&& location.text=="${Cred.location}"){
                      cred="";
            ...
            Row(
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Text("Sign up here",style: TextStyle(color: Colors.cyanAccent),),
                  onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context){
                      return MySignUp();
                    }));
